...
#parser = argparse.ArgumentParser(description='Write data to a MiFare card')
parser = argparse.ArgumentParser(prog="frame.py nfc_write",
                                formatter_class=argparse.RawDescriptionHelpFormatter,
                                description='Write NFC card Data.',
                                epilog="""Example usage:

        frame.py -w hello nfc_write """)

# Add a command-line argument for the data to write
parser.add_argument('-w', '--write-data', type=str, required=True,
                    help='The data to write to the MiFare card')
...
write_data = args.write_data.encode('utf-8')  # Use the provided data
